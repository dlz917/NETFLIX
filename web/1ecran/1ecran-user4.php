...
<form action="enregistrementchoix_1ecran_2.php" method="post">
    <div class="row">
      <div class="col-md-4 text-start">
...
<form action="enregistrementchoix_1ecran_2.php" method="post">
    <div class="row">
      <div class="col-md-4 text-start">
        <img src="../images/user3.png" alt="IMG" title="User3" width="25%">
      </div>
      <div class="col-md-2">
        <select class="form-control w-100 me-2 rounded-0 custom-select text-dark font-weight-bold" name="genre1">
            <option>Genre 1</option>
...
<form action="enregistrementchoix_1ecran_2.php" method="post">
    <div class="row">
      <div class="col-md-4 text-start">
        <img src="../images/user1.png" alt="IMG" title="User3" width="25%">
      </div>
      <div class="col-md-2">
        <select class="form-control w-100 me-2 rounded-0 custom-select text-dark font-weight-bold" name="genre1">
            <option>Genre 1</option>
